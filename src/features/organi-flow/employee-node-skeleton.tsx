...
export const EmployeeNodeSkeleton: React.FC<EmployeeNodeProps> = ({ employee }) => {
            ...
            <CardContent className="p-3 py-2">
              <div className="flex items-center gap-2">
                ...
                <Skeleton className="h-6 w-[120px] bg-neutral-200" />
                  ...
                  {employee.manager && (
                    <div className="text-[10px] text-gray-400 mt-1 select-none flex items-center gap-1">
                      Reports to: <Skeleton className="h-3.5 w-[40px] bg-neutral-200" />
                    </div>
                  )}
                </div>
              </div>
